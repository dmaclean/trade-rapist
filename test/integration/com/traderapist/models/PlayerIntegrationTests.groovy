...
class PlayerIntegrationTests {
	...
	void testGetPlayersInPointsOrder() {
		 ...
		 */
		def q1_stats = new FantasyPoints(player: q1, season: 2002, week: -1, system: ESPNStandardScoringSystem.class.getName(), points: 305).save(flush: true)
		def q2_stats = new FantasyPoints(player: q2, season: 2002, week: -1, system: ESPNStandardScoringSystem.class.getName(), points: 310).save(flush: true)
		def q1p_stats = new FantasyPoints(player: q1, season: 2002, week: -1, system: ESPNStandardScoringSystem.class.getName(), points: 300, projection: true).save(flush: true)
		def q2p_stats = new FantasyPoints(player: q2, season: 2002, week: -1, system: ESPNStandardScoringSystem.class.getName(), points: 295, projection: true).save(flush: true)

		def r1_stats = new FantasyPoints(player: r1, season: 2002, week: -1, system: ESPNStandardScoringSystem.class.getName(), points: 245).save(flush: true)
		def r2_stats = new FantasyPoints(player: r2, season: 2002, week: -1, system: ESPNStandardScoringSystem.class.getName(), points: 250).save(flush: true)
		def r1p_stats = new FantasyPoints(player: r1, season: 2002, week: -1, system: ESPNStandardScoringSystem.class.getName(), points: 250, projection: true).save(flush: true)
		def r2p_stats = new FantasyPoints(player: r2, season: 2002, week: -1, system: ESPNStandardScoringSystem.class.getName(), points: 245, projection: true).save(flush: true)
		 ...
		 * Quarterback results
		 */
		def qb_results = Player.getPlayersInPointsOrder(Player.POSITION_QB, 2002, ESPNStandardScoringSystem.class.getName())
		 ...
		 */
		def rb_results = Player.getPlayersInPointsOrder(Player.POSITION_RB, 2002, ESPNStandardScoringSystem.class.getName())
	...
	void testGetPlayersInPointsOrder_NonExistentScoringSystem() {
		 ...
		 * Define fantasy points for players - non projections should be ignored.
		 */
		def q1_stats = new FantasyPoints(player: q1, season: 2002, week: -1, system: DifferentScoringSystem.class.getName(), points: 305).save(flush: true)
		def q2_stats = new FantasyPoints(player: q2, season: 2002, week: -1, system: DifferentScoringSystem.class.getName(), points: 310).save(flush: true)
		def q1p_stats = new FantasyPoints(player: q1, season: 2002, week: -1, system: DifferentScoringSystem.class.getName(), points: 300, projection: true).save(flush: true)
		def q2p_stats = new FantasyPoints(player: q2, season: 2002, week: -1, system: DifferentScoringSystem.class.getName(), points: 295, projection: true).save(flush: true)

		def r1_stats = new FantasyPoints(player: r1, season: 2002, week: -1, system: DifferentScoringSystem.class.getName(), points: 245).save(flush: true)
		def r2_stats = new FantasyPoints(player: r2, season: 2002, week: -1, system: DifferentScoringSystem.class.getName(), points: 250).save(flush: true)
		def r1p_stats = new FantasyPoints(player: r1, season: 2002, week: -1, system: DifferentScoringSystem.class.getName(), points: 250, projection: true).save(flush: true)
		def r2p_stats = new FantasyPoints(player: r2, season: 2002, week: -1, system: DifferentScoringSystem.class.getName(), points: 245, projection: true).save(flush: true)
