...
<html>
	...
	<body>
		<a href="#edit-fantasyTeam" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-fantasyTeam" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${fantasyTeamInstance?.version}" />
				<fieldset class="form">
